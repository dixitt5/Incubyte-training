...
const Home = (): ReactElement => {
  ...
  const { fetchingOffset, setFetchingOffset } = useContext(FetchingOffsetContext)
  setFetchingOffset(10)

  const { pokemons, isLoading, error } = usePokemons(10, fetchingOffset)
